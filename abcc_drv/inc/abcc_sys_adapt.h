...
********************************************************************************
** Services:
**    ABCC_SYS_AbccInterruptEnable   - Enable hardware interrupt.
**    ABCC_SYS_AbccInterruptDisable  - Disable hardware interrupt.
**    ABCC_SYS_SyncInterruptEnable   - Enable sync interrupt.
**    ABCC_SYS_SyncInterruptDisable  - Disable sync interrupt.
...
**    ABCC_SYS_HwInit                - Initiate local hardware before driver
**                                     startup.
**    ABCC_SYS_GpioReset             - Clear a digital output for SYNC timing
**                                     measurements.
**    ABCC_SYS_GpioSet               - Set a digital output for SYNC timing
**                                     measurements.
