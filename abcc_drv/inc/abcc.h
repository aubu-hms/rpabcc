...
**    ABCC_TakeMsgBufferOwnership()  - Takes the ownership of the message
**                                     buffer.
...
**    ABCC_ModuleDetect()            - Detects if a module is present.
**    ABCC_IsSupervised()            - Get state of the SUP bit.
**    ABCC_SetMsgHeader()            - Sets message header fields.
**    ABCC_GetNewSourceId()          - Returns an incrementing source id.
**    ABCC_GetDataTypeSizeInBits()   - Returns size of ABCC data type in bits.
**
