...
void ABCC_TriggerAnbStatusUpdate( void )
{
   ...
   if( bAnbState != abcc_bAnbState )
   {
      ...
      ABCC_PORT_DebugPrint(( "HEXDUMP_STATE:%02x\n", abcc_bAnbState ));
#endif
...
{
#if( ABCC_CFG_DEBUG_HEXDUMP_MSG || ABCC_CFG_DEBUG_HEXDUMP_SPI || ABCC_CFG_DEBUG_HEXDUMP_UART )
   ABCC_PORT_DebugPrint(( "HEXDUMP_RESET:\n" ));
#endif
